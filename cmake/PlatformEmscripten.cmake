...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -s ALLOW_MEMORY_GROWTH=1 -s INVOKE_RUN=1 -s EXPORTED_FUNCTIONS=['_pudgywars_start','_pudgywars_mobile_control','_pudgywars_set_remote_players','_pudgywars_remote_control','_pudgywars_begin_browser_quick_play','_pudgywars_get_browser_flow_stage'] -s MINIFY_HTML=0 --preload-file ${CMAKE_SOURCE_DIR}/data@data")
