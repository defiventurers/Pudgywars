...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -s ALLOW_MEMORY_GROWTH=1 -s INVOKE_RUN=1 -s EXPORTED_FUNCTIONS=['_pudgywars_start','_pudgywars_mobile_control'] -s MINIFY_HTML=0 --preload-file ${CMAKE_SOURCE_DIR}/data@data")
